...
function init_map(latitude, longitude) {
    ...
    const imageBounds = {
      ...
      const groundOverlay = new google.maps.GroundOverlay(
        "http://yxpartners.co.jp/wp-content/uploads/2025/01/area_map1.png", // 重ねる画像のURL
        imageBounds
      );
...
function show_em_shelter_safe_Park() {
    ...
    em_shelter_time_element.innerText = 22;
    en_em_shelter_name_element.innerText = "Isogami Gymnasium";
    em_shelter_address_element.innerText = "神戸市中央区八幡通2-1-38";
}
